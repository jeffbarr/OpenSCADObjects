...
A 2-piece channel and matching cover for Adafruit [NeoPixels](https://www.adafruit.com/category/168). The channel is sized to fit strips within the weatherproof casing;
...
channels are sized so that they can be butted end-to-end.
